    ...
    private function updateOperation(Operation $operation) {
        ...
        switch ($operation->getName()) {
            ...
            case sprintf($routeNameTemplate, $uriTemplate, "patch"):
                ...
                break;
            case sprintf($routeNameTemplate, $uriTemplate, "post"):
                $denormalizationGroups = array_unique([...$denormalizationGroups, ...$this->getDefaultGroups($operation->getShortName(), false, false, "post")]);
                break;
        }
        $previousDenormalizationContext["groups"] = $denormalizationGroups;
        $updatedOperation = $updatedOperation->withDenormalizationContext($previousDenormalizationContext);
